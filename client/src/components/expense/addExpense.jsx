...
import { Box, Button, Chip, Container, FormControl, FormHelperText, Grid, IconButton, InputAdornment, InputLabel, MenuItem, Modal, OutlinedInput, Select, TextField, Typography, FormControlLabel, Checkbox, Collapse } from '@mui/material'
          ...
          <FormikProvider value={formik}>
            ...
            <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
              <Grid container spacing={3} sx={{ maxWidth: 800 }}>
                ...
                <Collapse in={formik.values.isRecurring} sx={{ width: '100%' }}>
